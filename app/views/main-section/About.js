        ...
        <div className="">
          ...
          <div className="flex flex-col md:flex-row justify-center gap-5 text-center">
            <div className="p-5 w-full xl:w-1/4 space-y-2 bg-base-100 rounded-2xl shadow-lg">
              ...
              <p className="text-xs text-gray-500">3 Years Working</p>
            </div>
            <div className="p-5 w-full xl:w-1/4 space-y-2 bg-base-100 rounded-2xl shadow-lg">
              <svg
                xmlns="http://www.w3.org/2000/svg"
              ...
              <p className="text-xs text-gray-500">20 + Projetcs</p>
            </div>
            <div className="p-5 w-full xl:w-1/4 space-y-2 bg-base-100 rounded-2xl shadow-lg">
              <svg
                xmlns="http://www.w3.org/2000/svg"
          ...
          <p className="py-8 leading-7 text-gray-600">
            Full-stack developer with 3 years of experience developing complex
            web apps from frontend to backend. Able to create attractive UI/UX
            with HTML, CSS, JavaScript. Very proficient in Vue and Next.js
            framework for frontend. On the backend, familiar with REST API and
            microservices with Express.js. Good communication and team
            collaboration skills. Successfully led 2 teams of developers to
            complete the project on time.
          </p>
          <div className="flex justify-center">
            <Link href="#contact" className="inline-block button emerald">
              Contact Me
            </Link>
          </div>
        </div>
